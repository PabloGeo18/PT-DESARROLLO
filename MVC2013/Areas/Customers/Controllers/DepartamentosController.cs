...
namespace MVC2013.Areas.Customers.Controllers
{
    public class DepartamentosController : Controller
    {
        ...
        {
            var departamentos = db.Departamentos.Where(x => x.activo && !x.eliminado);
        ...
        public ActionResult Create(Departamentos departamentos)
        {
            if (ModelState.IsValid)
            {
                ...
                departamentos.nombre = departamentos.nombre.ToUpper();
        ...
        public ActionResult Edit(Departamentos departamentos)
        {
            if (ModelState.IsValid)
            {
                ...
                departamentoEdit.nombre = departamentos.nombre.ToUpper();
