...
namespace MVC2013.Models
{
    ...
    public partial class Empleado_Permisos_Ausencias
    {
        public int id_empleado_permiso_ausencia { get; set; }
        ...
        public virtual Tipo_Permiso_Ausencia Tipo_Permiso_Ausencia { get; set; }
